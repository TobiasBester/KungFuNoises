...
export let TEAMS = {
  ...
  FLORIDA_MAYHEM: new Team('Florida Mayhem', 11, 'default-theme', '../assets/images/teams/fl_mayhem.svg', '../assets/images/team_backgrounds/fl_mayhem.jpg'),
  ...
  LONDON_SPITFIRE: new Team('London Spitfire', 4, 'default-theme', '../assets/images/teams/london_spitfire.svg', '../assets/images/team_backgrounds/london_spitfire.jpg'),
  LOS_ANGELES_GLADIATORS: new Team('Los Angeles Gladiators', 8, 'default-theme', '../assets/images/teams/la_gladiators.svg', '../assets/images/team_backgrounds/la_gladiators.jpg'),
  LOS_ANGELES_VALIANT: new Team('Los Angeles Valiant', 5, 'default-theme', '../assets/images/teams/la_valiant.svg', '../assets/images/team_backgrounds/la_valiant.jpg'),
  ...
  SAN_FRANCISCO_SHOCK: new Team('San Francisco Shock', 9, 'default-theme', '../assets/images/teams/sf_shock.svg', '../assets/images/team_backgrounds/sf_shock.jpg'),
  SEOUL_DYNASTY: new Team('Seoul Dynasty', 3, 'default-theme', '../assets/images/teams/seoul_dynasty.svg', '../assets/images/team_backgrounds/seoul_dynasty.jpg'),
